...
#   (Agro_1980-2024.csv) no se distribuye en el repositorio; este script se
...
#
# INPUT:  Agro_1980-2024.csv   (consulta cruda estatal; no incluida en el repo)
...
# --- PARÁMETROS -------------------------------------------------------------
INPUT             <- "Agro_1980-2024.csv"   # consulta cruda estatal (no en repo)
OUTPUT            <- "data_agregada_base.csv"
