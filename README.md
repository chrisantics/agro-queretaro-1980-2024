...
Análisis de la superficie sembrada en el estado de Querétaro, México, entre 1981 y 2024, a nivel estatal y municipal. Este repositorio acompaña al artículo *"Trayectoria de la superficie sembrada en Querétaro y sus quiebres estructurales, 1981–2024"*, en preparación para la revista NTHE.
...
```
.
├── 01_limpieza_estatal.R              Limpieza de la base estatal → serie anual de Querétaro
...
- Nivel estatal con desglose por grupo de cultivo: 1981–2024.
- Nivel municipal con desglose por modalidad (riego y temporal): 2003–2024.

Los datos crudos de origen están disponibles en [Kaggle](#) *(añadir enlace cuando se publique el dataset)*. Los datos procesados de este repositorio se generan a partir de ellos ejecutando los scripts en orden.

## Cómo reproducir el análisis

1. Clonar o descargar este repositorio.
2. Colocar los datos crudos de SIACON en la carpeta del proyecto (ver Kaggle).
3. Abrir R o RStudio en la carpeta del proyecto.
4. Ejecutar los scripts en orden numérico (`01` → `05`).
